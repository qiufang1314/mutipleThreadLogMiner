...
public abstract class RelationalDatabaseConnectorConfig extends CommonConnectorConfig {
    ...
    private String restoreScn;
    private final String twoPhaseInitial ;
    protected RelationalDatabaseConnectorConfig(Configuration config, String logicalName, TableFilter systemTablesFilter,
        ...
        this.restoreScn = config.getString("restoreScn","-1");
        this.twoPhaseInitial = config.getString("twoPhaseInitial","false");
    ...
    public String getRestoreScn() {return restoreScn; }
    public void setRestoreScn(String scn) { this.restoreScn = scn;}

    public String getTwoPhaseInitial() {return twoPhaseInitial;}
    /**
