...
public class Signal {
    ...
    public static class Payload {
         ...
         */
        public Payload(String id, String type,String rawData, Document data, OffsetContext offsetContext, Struct source) {
            super();
            this.id = id;
            this.type = type;
            this.data = data;
...
//            LOGGER.warn("Signal '{}' has arrived but the type '{}' is not recognized", id, type);
        ...
        try {
            ...
            return action.arrived(new Payload(id, type,data, jsonData, offset, source));
        }
        catch (IOException e) {
